    ...
    <div class="panel_exame_geral_detalhe col-sm-10 col-md-10">
        ...
        <div class="tab-content" id="div_table">
            <div id="lipidico" class="tab-pane active in fade">
                <form method="POST" action="<?php echo BASE_URL; ?>/cadastro/adicionar_exame_detalhe" class="" id="">
                    ...
                    <table class="table table-bordered table-responsive table-hover table-condensed" id="table_exame_detalhado">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="300"><?php if (!empty($linha['resultado'])) {echo $linha['resultado'];} else {echo "<span class='color_red'>Aguardando Resultado</span>";} ?></td>
                                <td width="150"><a id="" class="glyphicon glyphicon-zoom-in" aria-hidden="true" href="<?php echo BASE_URL; ?>/referencia/ver/<?php echo $linha['id_resultado_exame']; ?>"></a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table> 
                    ...
                    <div class="form-group">
                        <div class="div_btn_sair">
                            <button type="submit" id="btn_adc_exame" class="btn btn-primary" title="Clique aqui para Adicionar Tipo de Exame">Adicionar</button>
